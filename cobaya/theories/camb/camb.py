...
class CAMB(BoltzmannBase):
    ...
    def set(self, params_values_dict, state):
        ...
        try:
            ...
            # CHANGE for mnu: some parameters, e.g. 'num_nu_massless', 'nu_mass_degeneracies', 'nu_mass_fractions' are set after set_H0_for_theta call in set_params, here: https://github.com/cmbant/CAMB/blob/5d1de2d22c2236d4b044dca4e20e592de06d4a17/camb/camb.py#L182
            # So we need to reset H0 given theta manually
